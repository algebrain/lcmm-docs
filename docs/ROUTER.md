...
Репозиторий: `github.com/algebrain/lcmm-router`
...
Если нужен полный app-level порядок `init! -> add-route! -> as-ring-handler -> middleware`, см. [`APP_COMPOSITION.md`](./APP_COMPOSITION.md).
