...
Для канонического прохождения сценария используйте `bb start.bb --reset`.
Если нужно сохранить накопленные локальные данные между перезапусками, используйте `bb start.bb --continue`.
